...
| ROH_SUB_EXCEPTION         |             1005 | R                 |                                    | Error subcode                                                                                                                                                     |
| ROH_NODE_ID               |             1006 | R/W               | 2                                  | ROHand ID, only low byte is valid, ROHand will save and reboot when successfully written.                                                                         |
...
| Thumb bending | ![Finger Screen](res/ThumbBendingEN.png) | -12.69° ~ 36.76° |
| Thumb rotation | ![Finger Screen](res/ThumbRotation.png) | -2° ~ 92° |
